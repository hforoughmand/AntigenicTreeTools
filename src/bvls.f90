SUBROUTINE BVLS ( A, B, BND, X, RNORM, NSETP, W, INDEX, IERR , DIMN, DIMM )
...
!                                  Z(size(A,1)), BND(:,:)
      real(kind(one)) :: A(DIMN,DIMM), B(DIMN), S(size(A,2)), X(DIMM), W(DIMN),&
                                 Z(size(A,1)), BND(2,DIMM)
